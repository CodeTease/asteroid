...
export const upgradeFirerateBtn = document.getElementById('upgrade-firerate') as HTMLButtonElement;
export const upgradeDoubleshotBtn = document.getElementById('upgrade-doubleshot') as HTMLButtonElement;
export const upgradeProjectilespeedBtn = document.getElementById('upgrade-projectilespeed') as HTMLButtonElement;
...
export const autoUpgradeCheckbox = document.getElementById('auto-upgrade-checkbox') as HTMLInputElement;
...
export const upgradeLaserDamageBtn = document.getElementById('upgrade-laser-damage') as HTMLButtonElement;
export const upgradeLaserCooldownBtn = document.getElementById('upgrade-laser-cooldown') as HTMLButtonElement;
...
export function hideMessage(onHiddenCallback: () => void) {
    messageBox.classList.remove('visible');
    // Wait for animation to finish before restarting
    setTimeout(onHiddenCallback, 300);
}

export function updateUpgradePoints(points: number) {
...
export function updateUpgradeModal(points: number, upgrades: AllyUpgrades, hasLaserAlly: boolean) {
